...
function AllObjects() {
  ...
  const fetchObjects = async ({ pageParam = 0 }) => {
    const res = await fetch(
      `https://api.harvardartmuseums.org/object?apikey=a58b1ca8-7853-40e4-8734-f634a87b9be7&=${pageParam}`
    );
...
//     const lastPage = data?.pages[0].info.pages
...
//   console.log("data.pages", data?.pages[0].info.pages);
...
//   console.log("data.pages.records", data?.pages[0].records);
