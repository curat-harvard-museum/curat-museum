...
async function seed() {
  ...
  //   async function mapFavoriteObjects(){
  //     const objectArr = await fetchObjects();
  //     for(let i = 0; i < objectArr.length; i++){
  //           await Promise.all ([
  //             UserObject.create({
  //             userId: 1/* UserObject.userId*/,
  //             objectId: objectArr[i].id,
  //             primaryimageurl: objectArr[i].primaryimageurl,
  //             title: objectArr[i].title,
  //             description: objectArr[i].description,
  //             artist: objectArr[i].people[0].name,
  //           })
  //         ])
  //       }
  // }
  ...
  async function mapObjects() {
    ...
    // console.log('artwork[0]', artwork[0].dataValues)
    ...
    // artwork.forEach(async (work) => {
    //   seededUsers.forEach(async (user) => {
    //     await user.addObject(work)
    //   })
    // })
  }
