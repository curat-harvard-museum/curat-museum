...
async function seed() {
  ...
  const objects2 = [
    ...
    },
    {
      ...
      primaryimageurl:
        "https://static.greatbigcanvas.com/images/singlecanvas_thick_none/world-art-group/mod-pods-i,2599314.jpg",
      description:
        "Praesent luctus urna vitae lorem egestas, et tempor nisi consectetur. Suspendisse rutrum id neque ac rhoncus. Aenean finibus non nisl eget interdum. Vestibulum id magna massa. Suspendisse pretium mi eros. Nam suscipit odio vel tortor tincidunt, id fringilla velit sollicitudin. Etiam varius erat vel sem tempor luctus. Mauris sed arcu lorem. Duis faucibus lacus sit amet mi venenatis, sit amet egestas sapien vehicula. Nulla vitae tellus quis purus condimentum aliquam.",
      artist: "Picasso",
    },
    {
      objectid: 12347,
